...
export default async function handler(
  ...
  if (req.method === "POST") {
    ...
    if (action === "request-reset") {
      ...
      const mailOptions = {
        from: "kocsmatehungary@gmail.com",
        to: email,
        subject: "Jelszó-visszaállító link",
        text: `Használja az alábbi linket a jelszó visszaállításához: http://localhost:3000/passreset?token=${resetToken}`, //ide mehet valami embed
      };
